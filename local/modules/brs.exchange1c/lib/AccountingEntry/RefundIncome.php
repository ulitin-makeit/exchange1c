...
/**
 * Проводка "Возврат поступления".
 *
 * Документация: https://vm-wiki02.rs.ru/pages/viewpage.action?pageId=224728633
 */
class RefundIncome extends \Brs\Exchange1c\AccountingEntry
{

	public const ENTITY = 'REFUND_INCOME';
	public const ENTITY_NAME = '16. Возврат поступления';
	...
	protected function getNomenclatures(): array
	{
		...
		$productPrice = $this->refundCard['SUPPLIER_GROSS_RETURN']
			...
			+ $this->refundCard['RETURN_SUPPLIER']
